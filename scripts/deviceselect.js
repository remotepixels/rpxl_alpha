...
async function handleSelectionChange() {
  ...
  if (mainAudioContext?.ctx && mainAudioContext.ctx.state !== "closed") {
    mainAudioContext.ctx.close();
  }
  if (userAudioContext?.ctx && userAudioContext.ctx.state !== "closed") {
    userAudioContext.ctx.close();
  }
  mainAudioContext = {};
  userAudioContext = {};
